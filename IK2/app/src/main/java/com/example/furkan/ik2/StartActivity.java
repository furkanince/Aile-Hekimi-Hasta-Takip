...
import com.example.furkan.ik2.user_sign.LoginActivity;
import com.google.firebase.auth.FirebaseAuth;


import com.example.furkan.ik2.user_sign.RegisterActivity;
...
public class StartActivity extends AppCompatActivity {
    ...
    private void updateUI(){
        if (fAuth.getCurrentUser() != null){
            ...
            Intent startIntent = new Intent(StartActivity.this, Main2Activity.class);
