package com.example.furkan.ik2.user_sign;
...
import com.example.furkan.ik2.MainActivity;
...
import com.example.furkan.ik2.Main2Activity;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fUsersDatabase = FirebaseDatabase.getInstance().getReference().child("NoteUsers");
